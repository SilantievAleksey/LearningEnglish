    ...
    <div class="container_2">
        <div class="profile_main">
            <div class="profile_info">
                ...
                <div class="profile_main_text">
                    <p>Логин: <?php echo $user->login ?></p>
                    <p>Email: <?php echo $_COOKIE['email'] ?></p>
                    <p>Пароль: ********</p>
                    <p>Страна: <span id="user-country"></span> </p>
                    <p>Город: <span id="user-city"></span> </p>
                </div>
            </div>
            <div class="profile_courses">
                <h1>Пройдено уроков: </h1>
                <a href="profile_edit.php">Редактировать</a>
            </div>
        </div>
    </div>
</section>
