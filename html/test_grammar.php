...
<head>
    ...
    <link rel="stylesheet" href="../css/test_grammar.css">
        ...
        <div class="tabs_main">
            <nav>
                <ul>
                    ...
                    <li><a href="#">/</a></li>
                    <li><a href="#">Тесты по грамматике</a></li>
                </ul>
            </nav>
        </div>
    </div>
...
<section class="tests">
    <div class="container_2">
        <div class="tests_main">
            ...
            <p>Тесты – это отличная возможность узнать уровень своих знаний, поэтому мы подготовили для Вас целый сборник тестов по английскому языку на разные темы.</p>
            <p>При этом, наши тесты ориентированы на определение знаний в тех областях английского языка, которые являются наиболее трудными в изучении, например, артикли, грамматика, лексика. Одним из самых популярных тестов является тест на времена, которых в английском языке очень много.</p>
            <a href="#">1) Тест по английскому языку по глаголам </a><br>
            <a href="#">2) Тест на знание времен английского языка </a><br>
            <a href="#">3) Тест на модальные глаголы </a><br>
            <a href="#">4) Тест на инфинитив и герундий </a><br>
            <a href="#">5) Тест на прямую и косвенную речь </a><br>
            <a href="#">6) Тест на неправильные глаголы английского языка </a><br>
            <a href="#">7) Тест на лексику английского языка </a><br>
            <a href="#">8) Тест на множественное число существительных </a><br>
            <a href="#">9) Тест на исчисляемые и неисчисляемые существительные </a>
        </div>
    </div>
</section>
