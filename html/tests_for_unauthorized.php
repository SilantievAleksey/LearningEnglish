...
<head>
    ...
    <link rel="stylesheet" href="../css/tests_for_unauthorized.css">
    ...
    <div class="container_2">
        <div class="tests_main">
            <div class="tests_text">
                <h1>Тесты по английскому языку </h1>
                <p>Хотите проверить, насколько хорошо вы знаете английский? Тогда мы предлагаем вам пройти бесплатные интерактивные тесты по английскому языку онлайн.
                    Это наиболее простой, быстрый и точный способ определить уровень знаний человека. Мы разработали для вас целый сборник тестов по английскому языку, вы можете пройти их совершенно бесплатно. Мы предлагаем вам три вида проверки своих знаний: <br>
                </p>
            </div>
           <div class="tests_content">
               <div class="knowledge_test">
                   <img src="../images/KnowledgeTest.png" alt="KnowledgeTest">
                   <h1>Тесты на знание английского</h1>
                   <div id="anim_block" class="pullUp">
                       <p>Тесты на знание английского помогут вам определить свой уровень.</p>
                       <a href="list_knowledge_tests_english.php">Перейти к тестам</a>
                   </div>
               </div>
               <div class="grammar_test">
                   <img src="../images/GrammarKnowledge.png" alt="GrammarKnowledge">
                   <h1>Тесты по грамматике английского языка</h1>
                   <div id="anim_block" class="pullUp">
                       <p>Тесты по грамматике английского языка помогут вам узнать, <br> насколько уверенно вы себя чувствуете в использовании грамматических конструкций.</p>
                       <a href="test_grammar.php">Перейти к тестам</a>
                   </div>
               </div>
               <div class="words_test">
                   <img src="../images/Words.png" alt="Words">
                   <h1>Тесты на знание английских слов</h1>
                   <div id="anim_block" class="pullUp">
                       <p>Тесты на знание английских слов помогут вам определить, насколько велик ваш словарный запас <br> и как хорошо вы знаете слова по той или иной теме.</p>
                       <a href="test_words.php">Перейти к тестам</a>
                   </div>
               </div>
           </div>
        </div>
